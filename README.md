...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/nameless-surf-c905)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/nameless-surf-c905
```

A live public deployment of this template is available at [https://nameless-surf-c905.templates.workers.dev](https://nameless-surf-c905.templates.workers.dev)
